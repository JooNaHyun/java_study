...
import kr.ac.kopo.ctc.kopo31.dao.StudentScoreDaoImpl;
...
public class StudentScoreServiceImpl implements StudentScoreService{
   ...
   public pagination getPagination(int page, int countPerPage) {
		StudentScoreDaoImpl studentScoreDaoImpl = new StudentScoreDaoImpl();

		int totalData = studentScoreDaoImpl.count(); // 전체 데이터 개수를 가져옴
